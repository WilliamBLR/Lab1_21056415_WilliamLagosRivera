...
un daño base, que sera usado despues para calcular el daño final
...
;dom: nombre x costo x daño x efecto
;rec: lista tda accion o boleano falso
...
;en general el dominio sera la accion
;rec: lista
